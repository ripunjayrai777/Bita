...
<nav class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-2 shadow-sm sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.html">Bobina Hotel</a>
        ...
        <form>
          ...
          <div class="modal-body">
            <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
              Note: Your details must match with your ID.(Aadhar Card, passport,Driving ) that will we required during check-in.
            </span>
            <div class="container-fluid">
              <div class="row">
